...
public class ChatActivity extends AppCompatActivity {
    ...
    private TextView userName, userLastSeen,textDate;
...
//        Toast.makeText(this, messageReceiverName, Toast.LENGTH_SHORT).show();
        ...
        Picasso.get().load(messageReceiverImage).placeholder(R.drawable.proimg).into(userImage);
                ...
                filePath.putFile(fileuri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            ...
                            messageTextBody.put("message", filePath.getDownloadUrl());
...
//        textDate = (TextView) findViewById(R.id.textDate);
        ...
        messageAdapter = new MessageAdapter(messagesList,getBaseContext());
    ...
    {
        RootRef.child("UsersChat").child(messageReceiverID)
